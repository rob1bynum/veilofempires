...
const refreshBuilderProtocolCounter = () => {
  getAttrs([
    "rank",
    "protocol_slot_1","protocol_rank_1",
    "protocol_slot_2","protocol_rank_2",
...
on("sheet:opened", refreshBuilderProtocolCounter);
...
const validateBuilderStep = (step,callback) => {
  ...
  getAttrs(fields,values=>{
    ...
    } else if (step === 3 && protocolUsed !== protocolAvailable) {
      valid = false;
      message = `Spend all Protocol points before continuing (${protocolUsed}/${protocolAvailable}).`;

...
const generalRecalcEvents=["heritage","heritage_mirror","affiliation_city","affiliation","lore_skill_base","specialty","protocol_slot_1","protocol_slot_2","protocol_slot_3","armor_type",...CONDITION_KEYS.map(k=>`condition_${k}`)].map(f=>`change:${f}`).join(" ");

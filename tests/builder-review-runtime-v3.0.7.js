...
trigger("clicked:wizard_next",{});
if(String(attrs.builder_step)!=="7") throw new Error("Did not reach Review");
...
if(attrs.builder_review_protocol_1_name!=="Clockwork Precision") throw new Error("Protocol 1 review failed");
if(attrs.builder_review_protocol_2_name!=="Ghost Step") throw new Error("Protocol 2 review failed");
if(attrs.builder_review_protocol_3_name!=="Iron Heart") throw new Error("Protocol 3 review failed");
if(Number(attrs.builder_review_skill_athletics)<=0) throw new Error("Skill review failed");
console.log(JSON.stringify({
 ...
 message:attrs.builder_wizard_message
}));

...
attrs.affiliation_city="imperium";
attrs.builder_affiliation_imperium="house_veylan";
attrs.affiliation="";
attrs.protocol_slot_1="";
attrs.protocol_slot_2="ghost_step";
attrs.protocol_rank_2="1";
attrs.protocol_slot_3="iron_heart";
attrs.protocol_rank_3="1";
trigger("change:builder_affiliation_imperium",{newValue:"house_veylan"});
if(attrs.builder_signature_protocol_name!=="Clockwork Precision")
  throw new Error(`Signature display failed: ${attrs.builder_signature_protocol_name}`);
if(attrs.protocol_slot_1!=="clockwork_precision")
  throw new Error(`Signature not fixed in slot 1: ${attrs.protocol_slot_1}`);
if(attrs.protocol_slot_2!=="ghost_step" || attrs.protocol_slot_3!=="iron_heart")
  throw new Error("Additional Protocol choices were not preserved");
console.log(JSON.stringify({
  signature:attrs.builder_signature_protocol_name,
  slot1:attrs.protocol_slot_1,
  slot2:attrs.protocol_slot_2,
  slot3:attrs.protocol_slot_3
}));

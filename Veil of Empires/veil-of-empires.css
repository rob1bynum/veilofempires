...
.voe-banner {
  ...
  border-bottom: 0;
  background: #f8f5ed;
  box-shadow: inset 0 -8px 16px rgba(12,32,45,.08);
}
...
/* =========================================================
   Veil of Empires v2.1 compact header and summary layout
   ========================================================= */
.voe-banner {
  ...
  box-shadow: 0 5px 14px rgba(5,18,27,.22);
}

.voe-header {
  grid-template-columns: 180px minmax(360px, 1.7fr) minmax(220px, .82fr) !important;
  gap: 12px !important;
...
.voe-agent-summary {
  min-width: 0;
  padding: 8px;
  border: 1px solid rgba(222,197,135,.48);
  background: rgba(0,0,0,.2);
}

.voe-agent-summary h2 {
  margin: 0 0 7px;
  padding-bottom: 5px;
  color: var(--gold-light);
  font-size: 13px;
  ...
  text-transform: uppercase;
  letter-spacing: .13em;
  border-bottom: 1px solid rgba(222,197,135,.34);
}
...
.voe-summary-grid > div {
  display: grid;
  grid-template-columns: minmax(75px, 1fr) minmax(82px, auto);
  gap: 8px;
  align-items: center;
  min-height: 27px;
  padding: 3px 5px;
  border-bottom: 1px solid rgba(222,197,135,.14);
}

.voe-summary-grid span {
  color: #d8c9a6;
  font-size: 10px;
  text-transform: uppercase;
  letter-spacing: .06em;
...
.voe-summary-grid strong {
  color: #fff5dc;
  text-align: right;
  white-space: nowrap;
}

.voe-summary-grid input[type="number"] {
  ...
  border: 1px solid rgba(222,197,135,.28) !important;
}

.voe-summary-grid input[type="text"] {
...
.voe-summary-xp label {
  color: #d8c9a6;
  font-size: 9px;
}

.voe-summary-xp input {
...
@media (max-width: 1050px) {
  .voe-header {
    grid-template-columns: 160px minmax(340px, 1fr) !important;
  }
  .voe-brand,
  .voe-portrait-frame {
  ...
  .voe-character-portrait { max-height: 214px !important; }
  .voe-agent-summary {
    grid-column: 1 / -1;
  }
  .voe-summary-grid {
...
@media (max-width: 1050px) {
  .voe-banner { height: 96px; }
}


/* v2.3: condition automation */
.voe-condition-summary {
  width: 100%;
  min-height: 92px;
  margin-top: 10px;
  box-sizing: border-box;
  ...
  border: 1px solid rgba(117,75,34,.35);
}

/* =========================================================
   v2.3.1: wide, shallow Roll20 masthead
   Fill the available sheet width without increasing height.
   ========================================================= */
.voe-banner {
  width: 100% !important;
...
/* =========================================================
   v2.3.2: responsive masthead without image distortion
   The artwork keeps its native proportions and is cropped only
   vertically as needed to fill the shallow, full-width header.
   ========================================================= */
.voe-banner {
  width: 100% !important;
  height: clamp(96px, 9vw, 112px) !important;
  min-height: 96px !important;
  max-height: 112px !important;
  overflow: hidden !important;
  padding: 0 !important;
...
/* =========================================================
   v2.3.3: full logo, no cropping, no distortion
   The masthead remains full-width, while the artwork itself is
   centered and scaled proportionally inside the shallow header.
   ========================================================= */
.voe-banner {
  width: 100% !important;
  height: 112px !important;
  ...
  background:
    linear-gradient(90deg, #101318 0%, #1a1d22 18%, #f5efe3 50%, #1a1d22 82%, #101318 100%) !important;
}
